...
export default function VenueMapWorkspace({onNavigate}:{onNavigate:(screen:string)=>void}){
  ...
  const calendarSearchUrl=`https://www.google.com/search?q=${encodeURIComponent(`${searchedLocation} live music open mic bands events calendar venue booking`)}`;
  ...
  return <div style={{display:'grid',gap:16}}>
    <section className="panel"><p className="eyebrow">Live Venue Map</p><h2>Find stages that book musicians.</h2><p className="sub">Search open mics, bands, bars and breweries, or event venues separately so promising locations do not disappear inside one narrow result list.</p>
