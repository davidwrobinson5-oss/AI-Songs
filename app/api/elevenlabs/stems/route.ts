...
const providerFetch = createProviderFetch('elevenlabs/stems');
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const response = await providerFetch(`${ELEVENLABS_BASE}/v1/music/stem-separation?output_format=mp3_44100_192`, {
      method: 'POST',
