...
export default async function LoginPage({
    ...
    return (
      <main className={styles.shell}>
        <section className={styles.card}>
          ...
          <p className={styles.sub}>Request access to AI Songs.</p>
          <AccessRequestForm />
  ...
  return (
    <main className={styles.shell}>
      <ClerkLoading>
        <div className={styles.authBoot} aria-label="Loading secure sign in">
          <div className={styles.bootLogo}>🎶</div>
          <div className={styles.bootSpinner} />
          <span>Opening secure studio…</span>
        </div>
      </ClerkLoading>
