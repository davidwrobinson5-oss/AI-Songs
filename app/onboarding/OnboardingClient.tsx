    ...
    <main style={shell}>
      <section style={card}>
        ...
        <div>
          ...
          <h1 style={{ margin: '5px 0 7px', fontSize: '30px' }}>Email verified</h1>
          <p style={muted}>Your email is confirmed. We saved the details you already entered, so you can move straight to your plan and trial setup.</p>
        </div>
        ...
        <form onSubmit={continueOnboarding}>
          <button type="submit" disabled={busy} style={{ ...primary, width:'100%' }}>{busy ? 'Setting up…' : `Continue to ${TRIAL_DAYS}-Day Free Trial`}</button>
        </form>
      </section>
    </main>
  );
