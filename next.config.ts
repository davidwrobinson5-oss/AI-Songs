...
const contentSecurityPolicy = [
  ...
  "media-src 'self' blob: data: https://ynkrlatwwwaachijacmb.supabase.co",
  "font-src 'self' data:",
  "style-src 'self' 'unsafe-inline' https://api.mapbox.com",
  `script-src 'self' 'unsafe-inline' https://api.mapbox.com${isDev ? " 'unsafe-eval'" : ''}`,
  "connect-src 'self' blob: https://ynkrlatwwwaachijacmb.supabase.co https://api.mapbox.com https://events.mapbox.com",
...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), geolocation=(self), payment=(), usb=(), serial=(), bluetooth=(), microphone=(self)' },
